...
Public Class frmBMI
    ...
    Private Sub btnCompute_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCompute.Click
        If Not MissingData() Then
            ...
            bmi = weight / height ^ 2
            txtBMI.Text = FormatNumber(bmi, 1)
        End If
    End Sub
    ...
    Private Sub btnClear_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnClear.Click
        ...
        txtWeight.Focus()
    End Sub
    Private Sub txtWeight_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtWeight.Leave
        ValidateTextBox(txtWeight, MIN_WEIGHT, MAX_WEIGHT, "Weight")
    End Sub
    Private Sub txtFeet_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtFeet.Leave
    ...
    Private Sub ValidateTextBox(ByVal txtBox As TextBox, _
        ...
        If txtBox.Text <> "" And Me.ActiveControl IsNot btnExit And _
            Me.ActiveControl IsNot btnClear Then
    ...
    Private Sub frmBMI_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
